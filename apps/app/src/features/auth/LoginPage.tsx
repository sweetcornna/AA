  ...
  return (
    <div className="auth-page">
      <div className="mb-8 text-center">
        ...
        <div className="text-[28px] font-semibold tracking-[-0.024em]">
          AA 记账
        </div>
        <div className="mt-1.5 text-[15px]" style={{ color: "var(--label2)" }}>
          和朋友轻松 AA、记一笔、看谁欠谁
        </div>
      </div>
      ...
      {method === "otp" && otpStep === "request" && (
        <>
          ...
          <Button className="mt-4" disabled={busy || !email} onClick={sendCode}>
            {busy ? "发送中…" : "发送 6 位验证码"}
          </Button>
        </>
      )}
        ...
        <>
          ...
          <div className="mt-3 flex justify-center gap-5 text-[14px]">
            <button
              ...
              onClick={sendCode}
              style={{
                color: cooldown > 0 ? "var(--placeholder)" : "var(--blue)",
              }}
            >
      ...
      <div
        className="mt-[18px] text-center text-[14px]"
        style={{ color: "var(--label2)" }}
      >
        还没有账号？
        <Link
          ...
          <div className="flex gap-2">
            <Card className="flex-1">
              <button
                ...
                style={{ color: "var(--blue)" }}
                disabled={busy}
                onClick={() => devLogin("demo@aa.local")}
              >
                以「阿明」登录
              </button>
            </Card>
            <Card className="flex-1">
              <button
                ...
                style={{ color: "var(--blue)" }}
                disabled={busy}
                onClick={() => devLogin("xiaohong@aa.local")}
              >
                以「小红」登录
              </button>
            </Card>
